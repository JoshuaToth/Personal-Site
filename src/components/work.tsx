...
const workplaces: Workplace[] = [
  {
    ...
    mainTech:
      'Typescript - React - Graphql - Express - Apollo - Node.js - Highcharts',
  },
  {
    img: Hnb,
    ...
    mainTech: 'Typescript - React - GatsbyJS - Node.js - Magnolia (CMS)',
  },
  {
    img: Acuris,
    ...
    mainTech:
      'Typescript - React - Node.js - Golang - AWS - Docker - Travis - Terraform',
  },
  {
    img: Floomx,
    ...
    mainTech:
      'Typescript - Node.js - GatsbyJS - DatoCMS - Docker - Kubernetes - Prisma - Postgres',
  },
  {
    img: PA,
    ...
    mainTech:
      'Node.js - AWS (Lambda, Cognito, DynamoDB, AWS Gateway) - Travis - Terraform',
  },
]
...
const aussieJobs: Workplace[] = [
  {
    ...
    mainTech:
      '.Net (Classic ASP, Webforms, MVC, Web API) - AWS - SASS - Angular - Node',
  },
  {
