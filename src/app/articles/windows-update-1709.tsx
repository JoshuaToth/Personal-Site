...
So you've installed Windows update 1709 and now your IIS hosted website isn't working? (October 2017)

Common Symptoms: 
- 503 Unavailable
- App pool will immediately stop
- Windows errors stating something along the line of: '... application pool 'POOLNAME' ... Cannot read \\\\\\\\?\\\\\\<EMPTY\\> configuration file'
...
You will see folders representing your app pools but they look like shortcuts and can't be navigated to
* Delete the folders (If they cant be deleted, run in powershell: 'IISRESET /stop' and then delete them)
